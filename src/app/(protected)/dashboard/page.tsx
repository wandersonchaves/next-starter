  ...
  return (
    <div className="px-4 pt-6">
      <div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800">
          <h3 className="mb-4 flex items-center text-lg font-semibold text-gray-900 dark:text-white">
            ...
            >
              <svg
                className="ml-2 size-4 text-gray-400 hover:text-gray-500"
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="sm:hidden">
            ...
            <select
              id="tabs"
              className="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-t-lg border-0 border-b border-gray-200 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400"
            >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex min-w-0 items-center">
                      <Image
                        ...
                        src={
                          'https://images.unsplash.com/photo-1591337676887-a217a6970a8a?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="imac image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex min-w-0 items-center">
                      <Image
                        className="size-10 shrink-0"
                        src={
                          'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="imac image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex min-w-0 items-center">
                      <Image
                        className="size-10 shrink-0"
                        src={
                          'https://plus.unsplash.com/premium_photo-1681504446264-708b83f4ea12?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="watch image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex min-w-0 items-center">
                      <Image
                        className="size-10 shrink-0"
                        src={
                          'https://images.unsplash.com/photo-1561154464-82e9adf32764?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="ipad image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="shrink-0">
                      <Image
                        ...
                        src={
                          'https://images.unsplash.com/photo-1572441562604-134ff1a7cbb6?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="Neil image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="shrink-0">
                      <Image
                        className="size-8 rounded-full"
                        src={
                          'https://plus.unsplash.com/premium_photo-1671826911273-66599fa0e62d?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="Neil image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="shrink-0">
                      <Image
                        className="size-8 rounded-full"
                        src={
                          'https://images.unsplash.com/photo-1613496701765-97267d26e3df?q=80&w=3085&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="Neil image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="shrink-0">
                      <Image
                        className="size-8 rounded-full"
                        src={
                          'https://plus.unsplash.com/premium_photo-1722895673916-b4de4a536373?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="Neil image"
                        width={10}
                        height={10}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="shrink-0">
                      <Image
                        className="size-8 rounded-full"
                        src={
                          'https://plus.unsplash.com/premium_photo-1664392299365-9af884da911a?q=80&w=3190&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                        }
                        alt="Neil image"
                        width={10}
                        height={10}
          ...
          <div className="w-full">
            ...
            <div className="mb-2 flex items-center">
              ...
              <div className="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                <div className="bg-primary-600 dark:bg-primary-500 h-2.5 rounded-full"></div>
              </div>
            </div>
            <div className="mb-2 flex items-center">
              <div className="w-16 text-sm font-medium dark:text-white">
      ...
      <div className="my-4 grid grid-cols-1 xl:grid-cols-2 xl:gap-4">
        <div className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 xl:mb-0 dark:border-gray-700 dark:bg-gray-800">
          <div className="mb-4 flex items-center justify-between">
          ...
          <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
            <article className="mb-5">
              <footer className="mb-2 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-gray-600"
                  type="button"
                >
                  <svg
                    className="size-5"
              ...
              <Link
                href="#"
                className="text-primary-700 dark:text-primary-500 inline-flex items-center text-xs font-medium sm:text-sm"
              >
                4 replies
                <svg
            ...
            <article className="mb-5">
              ...
              <div className="mb-2 flex items-center space-x-2">
                <button
                  type="button"
                  className="inline-flex items-center rounded-lg bg-gray-100 px-3 py-1.5 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600"
                >
                  <svg
                    aria-hidden="true"
                    className="mr-2 h-5"
            ...
            <article className="mb-5">
              ...
              <div className="items-center 2xl:flex 2xl:space-x-4">
                {/* <!-- Item --> */}
                <div className="mb-3.5 flex items-center rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                  <div className="bg-primary-100 dark:bg-primary-900 mr-3 flex size-10 items-center justify-center rounded-lg">
                    <svg
                      className="text-primary-600 dark:text-primary-300 size-5 lg:size-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                      aria-hidden="true"
                ...
                {/* <!-- Item --> */}
                <div className="mb-3.5 flex items-center rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                  <div className="mr-3 flex size-10 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900">
                    <svg
                      className="size-5 text-teal-600 lg:size-6 dark:text-teal-300"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                      aria-hidden="true"
            ...
            <article className="mb-5 pl-12">
              ...
              <span className="text-primary-700 dark:text-primary-500 inline-flex cursor-pointer items-center text-xs font-medium hover:underline sm:text-sm">
                Hide thread
                <svg
                  className="ml-1 size-5"
                  fill="currentColor"
        ...
        <div className="grid gap-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800">
            <div className="items-center justify-between border-b border-gray-200 pb-4 sm:flex dark:border-gray-700">
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      name="start"
                      type="text"
                      className="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400"
                      placeholder="From"
                    />
                  </div>
                  <div className="relative">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            {/* <!-- Card Footer --> */}
            <div className="flex items-center justify-between pt-4 sm:pt-6 lg:justify-evenly">
              <div>
                <svg
                  className="mb-1 size-8 text-gray-500 dark:text-gray-400"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
              ...
              <div>
                ...
                <p className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                  <span className="mr-1.5 flex items-center text-sm text-red-600 dark:text-red-500">
                    <svg
                      className="size-4"
                      fill="currentColor"
                      viewBox="0 0 20 20"
      ...
      <div className="my-4 grid grid-cols-1 xl:grid-cols-2 xl:gap-4">
        ...
        <div className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 xl:mb-0 dark:border-gray-700 dark:bg-gray-800">
          ...
          <ol className="relative border-l border-gray-200 dark:border-gray-700">
            <li className="mb-10 ml-4">
              <div className="absolute -left-1.5 mt-1.5 size-3 rounded-full border border-white bg-gray-200 dark:border-gray-800 dark:bg-gray-700"></div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800">
          <div id="carousel" className="relative" data-carousel="">
            <div className="relative mx-auto h-[36rem] overflow-hidden lg:h-96">
              <div
                className="hidden bg-white duration-700 ease-in-out dark:bg-gray-800"
                data-carousel-item
              >
                <div className="text-primary-600 mb-4 flex items-center text-lg font-medium">
                  <svg
                ...
                <Link
                  href="#"
                  className="text-primary-700 dark:text-primary-500 inline-flex items-center rounded-lg p-2 font-medium hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  Get me there
                  <svg
                    className="ml-1 size-5"
              ...
              <div
                ...
                data-carousel-item
              >
                <div className="mb-4 flex items-center text-lg font-medium text-teal-500">
                  <svg
                    className="mr-2 size-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ul className="mb-4 list-disc space-y-3 pl-2 text-gray-500 dark:text-gray-400">
              ...
              <div
                ...
                data-carousel-item
              >
                <div className="mb-4 flex items-center text-lg font-medium text-purple-600">
                  <svg
                    className="mr-2 size-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                {/* <!-- List --> */}
                <ul className="my-5 mb-4 list-disc space-y-3 pl-2 text-gray-500 dark:text-gray-400">
                ...
                <button
                  type="button"
                  className="hover:text-primary-700 inline-flex items-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  View more
                  <svg
                    className="ml-1 size-5"
          ...
          <div className="items-center sm:flex">
            <div className="flex items-center">
              <button
                ...
                className="mb-4 mr-4 inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 sm:mb-0 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                type="button"
              >
                Filter by status
                <svg
