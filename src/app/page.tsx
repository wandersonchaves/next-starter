  ...
  return (
    <section className="container mt-10 flex flex-col items-center gap-3 text-center md:absolute md:left-1/2 md:top-1/2 md:mt-0 md:-translate-x-1/2 md:-translate-y-1/2">
      <h1 className="mb-1 font-mono text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">
        {m.next_commerce_template_headline()}
      </h1>
      <p className="text-muted-foreground max-w-2xl">
        {m.next_commerce_template_description()}
      </p>
      <div className="mt-1">
        <HeroForm />
      </div>
      <div className="mt-2 flex gap-4">
        <Button asChild>
          <a
            href="https://github.com/wandersonchaves/next-commerce/blob/main/README.md#getting-started"
            target="_blank"
          >
            {m.get_started()}
          </a>
        ...
        <Button variant="outline" asChild>
          <a
            href="https://github.com/wandersonchaves/next-commerce"
            target="_blank"
          >
